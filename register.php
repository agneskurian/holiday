  ...
  <body class="tm-gray-bg">
  			...
  			<div class="row">
	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						...
						<li><a href="ulogin.php" class="active">Login</a></li>
	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			...
			<form class="form-search" action="registeraction.php" method="post">
<table width="351" height="283" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td><textarea name="address" cols="" rows="" required></textarea>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="confirmpassword" type="password"></td>&nbsp;</td>
  </tr>
  
  <!-- <tr>
    <td><label>User Id</label>&nbsp;</td>
    <td bordercolor="#FFFFFF" bgcolor="#FFFFFF"><input name="" type="text">&nbsp;</td>
    <td bordercolor="#FFFFFF" bgcolor="#FFFFFF">&nbsp;</td>
  </tr> -->
</table>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="submit" name="register" name="register">Register</button>
</form>

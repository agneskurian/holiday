...
<head>
  ...
  <title>Musicana -Euphorium</title>
<!--
Holiday Template
 ...
 -->			  <!-- <ul class="slides">
			...
			<div class="row>		
				 <div class="tm-section-header"> 
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">Welcome to Musicana</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>	-->
								      	 <div class="section-margin-top">
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="img/Eupho/eu1.jpg" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">						
					     <a href="#"><img src="img/Eupho/eu2.jpg" alt="img" class="tm-about-box-1-img"></a>
		...
		<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">						
					<a href="#"><img src="img/Eupho/eu3.jpg" alt="img" class="tm-about-box-1-img"></a>
                        <h3 class="tm-about-box-1-title">Thomas <span>( Founder )</span></h3>
						<p class="margin-bottom-15 gray-text">Proin gravida nibhvell aliquet. Aenean sollicitudin bibum auctor nisi elit.</p>
						<!-- <div class="gray-text">
							<a href="#" class="tm-social-icon"><i class="fa fa-twitter"></i></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="img/Eupho/eu4.jpg" alt="img" class="tm-about-box-1-img"></a>
						<h3 class="tm-about-box-1-title">Keith <span>( Co-Founder )</span></h3>
						<p class="margin-bottom-15 gray-text">Proin gravida nibhvell aliquet. Aenean sollicitudin bibum auctor nisi elit.</p>
						<!-- <div class="gray-text">
							<a href="#" class="tm-social-icon"><i class="fa fa-twitter"></i></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
						<img src="img/014.jpg" alt="image" class="img-responsive">
						<h4>Proin Gravida Nibhvel Lorem Quis Bind</h4>
...
<!-- 			    </li>
 -->			    -->
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="img/Eupho/eu5.jpg" alt="img" class="tm-about-box-1-img"></a>
						<h3 class="tm-about-box-1-title">Thomas <span>( Founder )</span></h3>
						<p class="margin-bottom-15 gray-text">Proin gravida nibhvell aliquet. Aenean sollicitudin bibum auctor nisi elit.</p>
					</div>
				</div>
				<!-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
					      <a href="#"><img src="img/Eupho/dd6.jpg" alt="img" class="tm-about-box-1-img"></a>
                          <h3 class="tm-about-box-1-title">Keith <span>( Co-Founder )</span></h3>
                          <p class="margin-bottom-15 gray-text">Proin gravida nibhvell aliquet. Aenean sollicitudin bibum auctor nisi elit.</p>
						 --><!-- <div class="gray-text">
							<a href="#" class="tm-social-icon"><i class="fa fa-twitter"></i></a>
		 ...
		 -->				<!-- <div class="gray-text">
				 ...
				 --><!-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="img/drums/dd6.jpg" alt="img" class="tm-about-box-1-img"></a>

  		...
  		<div class="container">
  			<div class="row">
  				<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
  					<a href="#" class="tm-site-name"><i>Musicana</i></a>	
  				</div>
		...
		<div class="flexslider flexslider-banner">
		  <ul class="slides">
		    <li>
				...
				<img src="img/kk.jpg" alt="Image" />	
		    </li>
		    <li>
			    <div class="tm-banner-inner">
					<h1 class="tm-banner-title">We <span class="tm-yellow-text">Prefers</span> your choices</h1>
					<p class="tm-banner-subtitle">Just Try</p>
					<a href="#more" class="tm-banner-link">Learn More</a>	
				</div>
		      <img src="img/euu.jpg" alt="Image" />
		    </li>
		    <li>
			 <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="img/ppp1.jpg" alt="Image" />
		    </li>
 ...
 --> 
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-center">
									<a href="login.php">
                         <img src="img/ppi.jpg" alt="image" class="img-responsive"></a>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-center">
										<a href="login.php"><img src="img/ddi.jpg" alt="img" class="img-responsive"></a>
                               <div class="tm-green-gradient-bg tm-city-price-container">
							<span>Drums</span>
							<span>$2,600</span>
						</div>	
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				...
				<a href="login.php">
                <img src="img/tt1.jpg" alt="image" class="img-responsive"></a>
						<div class="tm-red-gradient-bg tm-city-price-container">
<!-- 						<a href="login.php" class="tm-home-box-2-link">
 -->                            <span>Guitar</span>
							<span>$4,200</span>
						</div>	
					</a>					

<?php
	...
	{
	$s2="insert into items values('".$_POST['pid']."','".$_POST['pname']."','".$_POST['category']."','".$_POST['cpname']."','".$_POST['image']."','".$_POST['des']."','".$_POST['available']."','".$_POST['price']."')";
	mysql_query($s2);
	}
?>
<!DOCTYPE html>
  		...
  		<div class="container">
  			<div class="row">
	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						<ul>
							<li><a href="pentry.php">Product Entry</a></li>
							<li><a href="admin.php" class="active">View order</a></li>
			  ...
			  <ul class="slides">
			    <li>
			      ...
			      <div class="flex-caption">
					...
					<center><h4 class="title"><span class="text"><strong>Product Entry</strong></span></h4>

					<form action="" method="post">
<table width="351" height="283" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  <tr>
  ...
  <tr>
    <td><label>Categoy</label>&nbsp;</td>
	<td>
		<select name="category">
		<?php
	 	 while($op=mysql_fetch_array($r1))
		 {?>
				<option><?php echo $op['cname']?></option><?php
		 }?>
		</select>
	</td>
  </tr>
    ...
    <td><input name="cpname" type="text">&nbsp;</td>
  </tr>
  <tr>
    <td><label>Select Image</label>&nbsp;</td>
	<td><input name="image" type="file" value="choose image">&nbsp;</td>
 </tr>
  <tr>
    <td><label>Description</label>&nbsp;</td>
	<td><input name="des" type="text" value="">&nbsp;</td>
 </tr>
  <tr>
    <td><label>Available Items</label>&nbsp;</td>
